    ...
    <div data-slot="command-input-wrapper" className="p-1 pb-0">
      <InputGroup>
        <CommandPrimitive.Input
          ...
          className={cn(
            // Reset the native input: the wrapper owns the background, height and radius.
            "h-full w-full border-0 bg-transparent p-0 text-sm text-foreground outline-hidden",
